...
namespace ds::adt {
    ...
    public:
        ...
        virtual bool tryFind(const K& key, T*& data) const = 0;         // *& ukazovatel referencie mozeme upravit
    ...
    { 
        ...
        /*return this->getSequence()->findBlockWithProperty([&](BlockType* Block) {
            return 
            });*/
    }
...
// po implementacii vymazte vyhodenie vynimky!
        ...
        if (contains(key))
        {
            throw std::runtime_error("Tabu¾ka už obsahuje prvok s daným k¾úèom.");
        }
        TableItem<K, T>* prvokTabulky = this->getSequence().insertLast()->data_;
...
// po implementacii vymazte vyhodenie vynimky!
        ...
        TableItem* prvokTabulky = this->getSequence().insertFirst()->data_;
        prvokTabulky->key_ = key;
        prvokTabulky->data_ = data;*/
    }
